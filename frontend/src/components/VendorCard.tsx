...
export const VendorCard: React.FC<VendorCardProps> = ({ vendor, summary }) => {
  return (
    <article
      className="rounded-2xl border border-[rgb(var(--border-muted))] bg-[rgb(var(--bg-surface))] p-6 shadow-sm transition-colors"
    ...
    >
      ...
      <section className="mt-6">
        ...
        <dl className="mt-3 grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-[rgb(var(--border-muted))] bg-[rgb(var(--bg-subtle))] p-4">
